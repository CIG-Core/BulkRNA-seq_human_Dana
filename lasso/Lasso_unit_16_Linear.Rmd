...
library(openxlsx)
output_path <- "/ix/cigcore/proj/biswas/code/Sissi/BulkRNA-seq_human_Dana/lasso/TPM/Linear/AllModule(518gene)_TPM_16.xlsx"
write.xlsx(gene_TPM_treat, file = output_path)
```
```{r}
library(xfun)

xfun::embed_files(c('./TPM/Linear/AllModule(518gene)_TPM_16.xlsx'))
```
